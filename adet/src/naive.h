...
using namespace std;
class naive_predictor: public ml_predictor{
public:
  naive_predictor();
  ...
  void Train( const int PredIdx, const vector< vector< float > >& TrainEx );
 ...
 /*****************************************************************************************
  *vector< vector< float > > Test( const vector< vector< float > >& TestEx, const float& t_val ) const;
  *   TestEx: vector of Testing Examples;
  ...
  *
  *****************************************************************************************/
  int naive_predictor::k_FoldXV( const int PredIdx, const vector< vector< float > >& TrainEx );
  ...
  * 03.08.2006	djh	added t_val to parameter list
  **********************************************************************/
  virtual vector< float > naive_predictor::TestHelper( const vector< float >& Ex, const float& t_val ) const;  

...
#include <string>
#include <vector>
#include <ctime> // necessary for seeding random number generator
 ...
 **********************************************************************/
 class bpnn: public nn{
   public:
    ...
    /*********************************************************************************************************
     * void bpnn::TrainOnlineHelper( const vector< vector< double > >& pat, const vector< vector< double > >& tgt, double& lrate, double& eta )
     * param:
     *   pat - vector of pattern vectors
     *   tgt - vector of target vectors
     *   lrate - learning rate
 ...
 class adetnn: public bpnn{
   public:
     ...
     **********************************************************************/
     ...
     virtual void Train( const vector< vector< float > >& Ex, double& lrate, double& eta, float bdA, float bdB );
     ...
     * param:
     *   nFolds - number of folds (1-N)
     *   Ex - vector of Training Examples, first element is target
     *   lrate - learning rate
     * return:
     *
     **********************************************************************/
     void k_FoldXV( const int nFolds, vector< vector< float > > Ex, double& lrate, double& eta, float bdA, float bdB );
     ...
     *
     **********************************************************************/
     void TrainXV( const vector< vector< float > >& TrainEx, vector< vector< float > >& TestEx, double& lrate, double& eta, float bdA, float bdB );
     
    /**********************************************************************
     * vector< double >  adetnn::TestHelper( const vector< double >& Ex )const {
     * param:
     ...
     *
     **********************************************************************/
     virtual vector<float> TestHelper( const vector< float >& Ex, const float& t_val ) const;
     ...
     *
     **********************************************************************/
     virtual vector< vector< float > > Test( const vector< vector< float > >& Ex, const float& t_val );
 ...
 **********************************************************************
 **********************************************************************/
 class adet_ptron: public adetnn{
   public:
    /**********************************************************************
     * adet_ptron(  )
     * Default constructor
     ...
     *
     ***********************************************************************/
     adet_ptron( const int& numI, const int& numOut, const double err, const int iter );
     ...
     *
     ***********************************************************************/ 
     adet_ptron( const vector<nn_layer* > l, const double err, const int iter );
     ...
     *
     **************************************/
     adet_ptron( const adet_ptron& origVal );
     ...
     * 
     **********************************************************************/
     const adet_ptron& operator=(const adet_ptron& origVal);

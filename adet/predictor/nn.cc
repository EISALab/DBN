 ...
 **********************************************************************/ 
 void adetnn::Print( ostream& o )const{
   ...
   o << setw(15) << _lrate << setw(15) << _eta << setw(15) << _bdA << setw(15) << _bdB << endl;
 }
 ...
 *
 **********************************************************************/
 void adetnn::Train( const vector< vector< float > >& Ex ){
   cout << "# Training\n";
   ...
   bpnn::TrainBatch_BoldDriver( pat, tgt, _lrate, _eta, _bdA, _bdB );
...
/**********************************************************************
 * void adetnn::k-FoldXV( const vector< vector< float > >& Ex )
 * purpose:
 ...
 **********************************************************************/
 void adetnn::k_FoldXV( const vector< vector< float > >& Ex ){
   // number of folds
  int nFolds = 10;
...
/**********************************************************************
 * void adetnn::TrainXV( const vector< vector< float > >& TrainEx, vector< vector< float > >& TestEx ){
 * param:
 ...
 **********************************************************************/
 void adetnn::TrainXV( const vector< vector< float > >& TrainEx, vector< vector< float > >& TestEx ){
   ...
   bpnn::TrainXV( TrainPat, TrainTgt, TestPat, TestTgt, _lrate, _eta, _bdA, _bdB );
   // calculate
   float sum_x=0.;
   float sum_xx=0.;
   vector< vector< double > > outs;
 ...
 *
 **********************************************************************/
 vector<float> adetnn::TestHelper( const vector< float >& Ex )const{
   vector< double > pat( Ex.size()-1 );
   vector< double > tgt( 1 );
   tgt[0]=double(Ex[0]);
   //cout << "Target is: " << tgt[0] << endl;
 ...
 *
 **********************************************************************/
 vector< vector< float > > adetnn::Test( const vector< vector< float > >& Ex )const{
   cout << "# Testing\n";

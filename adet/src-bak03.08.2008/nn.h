 ...
 **********************************************************************/
 class adetnn: public bpnn{
   public:
     ...
     *
     **********************************************************************/
     void k_FoldXV( const int nFolds, const vector< vector< float > >& Ex, double& lrate, double& eta, float bdA, float bdB );
     ...
     *
     **********************************************************************/
     virtual vector<float> TestHelper( const vector< float >& Ex );
     ...
     *
     **********************************************************************/
     virtual vector< vector< float > > Test( const vector< vector< float > >& Ex );
